...
//  full ImGuiKey range. 2019-04-03: Misc: Renamed Implfreeglut.cpp/.h to
//  ImplGLUT.cpp/.h. 2019-03-25: Misc: Made io.DeltaTime always above
...
#ifdef FREEGLUT
  io.BackendPlatformName = "ImplGLUT (freeglut)";
#else
  io.BackendPlatformName = "ImplGLUT";
#endif
  g_Time = 0;
