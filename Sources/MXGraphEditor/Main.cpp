...
int main(int argc, char *const argv[])
{
  ...
  // Append the standard library folder, giving it a lower precedence than
...
# endif /* TARGET_OS_IPHONE */
  ...
  // Set ini and log filename to NULL. This will prevent the automatic creation
  // of imgui.ini in the same folder as the saved material.
  // TODO: Consider setting the ini and log file paths to an application
  // directory.
  io.IniFilename = NULL;
  io.LogFilename = NULL;
