...
CPUMTLVertexBuffer::CPUMTLVertexBuffer(int numElements, int numVertices)
    : _numElements(numElements), _numVertices(numVertices), _buffer(nullptr),
      _dirty(true) {}
...
CPUMTLVertexBuffer *CPUMTLVertexBuffer::Create(int numElements, int numVertices,
                                               MTLContext *context) {
...
void CPUMTLVertexBuffer::UpdateData(const float *src, int startVertex,
                                    int numVertices, MTLContext *context) {
  _dirty = true;
  memcpy(((float *)_buffer.contents) + startVertex * _numElements, src,
