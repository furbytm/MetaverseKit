...
///     - Validation: All shader stages are compiled and atteched to a MSL
///     shader program.
...
///     generated the MSL code generator
...
public:
  ...
  MetalFramebufferPtr getFramebuffer() const { return _framebuffer; }

  /// Return the MSL program.
  MslProgramPtr getProgram() { return _program; }
...
protected:
  MslRenderer(unsigned int width, unsigned int height,
